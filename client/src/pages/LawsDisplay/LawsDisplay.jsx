  ...
  "ECOCIDE", "LEGAL GUARDIANSHIP", "ECOCENTRIC CORPORATE GOVERNANCE", "ECOCENTRIC LAND MODELS"]}/>
        ...
        <div className="content-box">
          ...
          <div className="card-box">
            ...
            <TemplateCard className="law-card" currentFilter={checked} law="ordinance" jurisdiction="regional" type="type" title="Title" summary="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."/>
            <TemplateCard className="law-card" currentFilter={checked} law="ordinance" jurisdiction="national" type="type" title="Title" summary="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."/>
            <TemplateCard className="law-card" currentFilter={checked} law="ordinance" jurisdiction="international" type="type" title="Title" summary="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."/>
            <TemplateCard className="law-card" currentFilter={checked} law="ordinance" jurisdiction="local" type="type" title="Title" summary="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."/>
            <TemplateCard className="law-card" currentFilter={checked} law="resolution" jurisdiction="local" type="type" title="Title" summary="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."/>
          </div>
        </div>
      </div>
    </div>
